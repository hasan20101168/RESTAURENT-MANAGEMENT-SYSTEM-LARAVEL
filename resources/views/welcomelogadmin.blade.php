...
<body>
    <div class="navbar">
        <ul id="list1">
            ...
            <li class="notice">
                <a class="logout2" href="/updatenotice">Notice</a>
            </li>
    ...
    <div id="midsec">
        ...
        <div class="employemanage">
            <a id="empmanage" href="/employees">Employee Management</a>
        </div>
    ...
    <div id="bottomsec">
        ...
        <p><a href="/inventorymanage"> Inventory Management </a></p>
    </div>
</body>
</html>
